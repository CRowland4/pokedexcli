...
func LocationCacher() (cacheLocations func(*pokecache.Cache, string) ([LocationCount]string)) {
	currentLocationID := 1
	
	cacheLocations = func(cache *pokecache.Cache, command string) (locations [LocationCount]string) {
